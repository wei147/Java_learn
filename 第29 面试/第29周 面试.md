...
<img src="C:\Users\w1216\AppData\Roaming\Typora\typora-user-images\image-20230129140728865.png" alt="image-20230129140728865" style="zoom:40%;" />
...
<mapper namespace="com.wei.interview.mybatis.mapper.EmpMapper">
    <!--开启二级缓存。 size代表当前二级缓存中最多容纳多个对象。
                eviction 代表超出缓存了该怎么处理,这个会将多余的对象通过算法进行清除。 LRU最少最近会被清除。
                flushInterval 采用一个时间间隔来定时进行缓存清除 (单位是毫秒。这里是60秒)
                readOnly="true" 保存在缓存中的这些对象都是只读的,不允许被修改    -->
    <cache size="512" eviction="FIFO" flushInterval="60000" readOnly="true"/>
    <!--这里设置为不使用缓存 useCache="false"-->
    <select id="findAll"
            resultType="com.wei.interview.mybatis.entity.Employee" useCache="false">
        select *
        from emp
    </select>

    <select id="findById" parameterType="int"
            resultType="com.wei.interview.mybatis.entity.Employee" useCache="true">
        select *
        from emp
        where empno = #{value}
    </select>
...
<img src="C:\Users\w1216\AppData\Roaming\Typora\typora-user-images\image-20230307002626908.png" alt="image-20230307002626908" style="zoom:33%;" />

#### SpringBoot面试题目

<img src="C:\Users\w1216\AppData\Roaming\Typora\typora-user-images\image-20230307005512326.png" alt="image-20230307005512326" style="zoom:33%;" />

<hr>

<img src="C:\Users\w1216\AppData\Roaming\Typora\typora-user-images\image-20230307005707914.png" alt="image-20230307005707914" style="zoom:25%;" />

<hr>

<img src="C:\Users\w1216\AppData\Roaming\Typora\typora-user-images\image-20230307005728359.png" alt="image-20230307005728359" style="zoom:25%;" />

```
yml proprie
```

<img src="C:\Users\w1216\AppData\Roaming\Typora\typora-user-images\image-20230307005545059.png" alt="image-20230307005545059" style="zoom:33%;" />

#### Maven的构建生命周期

<img src="C:\Users\w1216\AppData\Roaming\Typora\typora-user-images\image-20230307005850752.png" alt="image-20230307005850752" style="zoom:33%;" />
