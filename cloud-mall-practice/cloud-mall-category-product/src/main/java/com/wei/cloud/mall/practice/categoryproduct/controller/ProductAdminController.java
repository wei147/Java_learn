...
import com.wei.cloud.mall.practice.categoryproduct.model.request.UpdateProductReq;
...
public class ProductAdminController {
    ...
    public ApiRestResponse upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) {
        ...
        //创建文件
        File fileDirectory = new File(ProductConstant.FILE_UPLOAD_DIR);//文件夹
        File destFile = new File(ProductConstant.FILE_UPLOAD_DIR + newFileName);//目标文件
//判断文件夹是否存在
